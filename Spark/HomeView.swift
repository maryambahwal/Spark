...
struct HomeView: View {
    ...
    @State private var tasks: [Task] = [] // Task list managed with @State
    ...
    var body: some View {
        ZStack {
            if tasks.isEmpty {
                ...
                TaskList(tasks: $tasks) // Pass the tasks binding to TaskList
            }
                ...
                VStack {
                    ...
                    HStack {
                        ...
                        .sheet(isPresented: $isTaskSheetPresented) {
                            TaskSheet(tasks: $tasks) // Pass binding to tasks
                        }
                    }
                }
            }
